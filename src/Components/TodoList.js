  ...
  return (
    <div className='mt-4'>
        <div className='flex px-3 py-3  rounded-lg bg-orange-400 text-white text-center lg:w-72' id='btn'>
            <div className='flex items-center sm:pl-3 justify-between cursor-pointer'>
            ...
            <FontAwesomeIcon icon={faTrash} onClick={()=> deleteButton(task.id)} id='trash' className='sm:pl-3 sm:pr-2 cursor-pointer' />
            </div>
            </div>
        </div>
    </div>
